...
AGE_MODEL = os.path.join(BASE_DIR, "age_net2.caffemodel")
...
def all():
    global frame, angry, happy, sad, surprise, neutral, stop, male, female, child, teenager, adult 
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        if face_roi.shape[0] > 10 and face_roi.shape[1] > 10:
            try:
                ...
                print("Child:", child, "Teenager:", teenager, "Adult:", adult, "sum:", child + teenager + adult)
                print("Happy:", happy, "Sad:", sad, "Angry:", angry, "Surprise:", surprise, "Neutral:", neutral, "sum:", happy + sad + angry + surprise + neutral)
                print("Male:", male, "Female,", female, "sum:", male + female)
...
IMAGE_FOLDER = r"C:\Users\sahib\Desktop\dataset\adult18--"
image_files = [os.path.join(IMAGE_FOLDER, f) for f in os.listdir(IMAGE_FOLDER) if f.endswith((".jpg", ".png", ".jpeg"))]
output_folder = r"C:\Users\sahib\Desktop\dataset\output"
while True:
    global frame
